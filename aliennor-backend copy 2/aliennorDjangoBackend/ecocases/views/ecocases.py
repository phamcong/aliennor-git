...
from ..models import Ecocase, EcocaseRating, ESM, Ecocase2ESM, Category, EcocaseComment
...
def get_ecocases(request):
    ...
    if esms is not None:
        ...
        for ecocase2esm in all_ecocase2esms:
            ecocases[ecocase2esm.ecocase.id] = model_to_dict(Ecocase.objects.get(id=ecocase2esm.ecocase.id))
