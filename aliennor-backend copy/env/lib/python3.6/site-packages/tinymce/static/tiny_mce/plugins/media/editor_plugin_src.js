...
(function() {
	...
	tinymce.create('tinymce.plugins.MediaPlugin', {
		...
		imgToObject : function(node, args) {
			...
			function addPlayer(video_src, poster_src) {
				...
				if (flashPlayer) {
					...
					// Convert the ecocase url to absolute urls
			...
			if (data.params.src) {
				// Is flv ecocase add player for it
		...
		objectToImg : function(node) {
			...
			// Use src not ecocase
			if (data.params.ecocase) {
				data.params.src = data.params.src || data.params.ecocase;
				delete data.params.ecocase;
			}
